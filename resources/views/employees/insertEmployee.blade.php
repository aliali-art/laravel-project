...
<div class="container">
    <div class="portlet-body form well" >
        <div id="repeat_hide">
            ...
            <form  method="post" action="{{url('employees')}}" id="defaultForm"
                               ...
                               <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" autofocus="" placeholder="{{@trans('public.firstname')}} :" name="firstname" id="firstname" autocomplete="off" >
                                        </div>
                                        <div class="col-md-6">
                                            <label for="da_firstname">{{@trans("public.da_firstname")}}<span style="color:red"> : </span></label>
                                            <input type="text" class="form-control" autofocus="" placeholder="{{@trans('public.da_firstname')}} :" name="da_firstname" id="da_firstname" autocomplete="off" >
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"  name="lastname" placeholder="{{@trans('public.lastname')}} :" autocomplete="off" class="form-control" id="lastname">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="da_lastname">{{@trans("public.da_lastname")}}<span style="color:red"> : </span></label>
                                                <input type="text"  name="da_lastname" placeholder="{{@trans('public.da_lastname')}} :" autocomplete="off" class="form-control" id="da_lastname">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" value="" name="feturework" id="feturework" class="form-control" placeholder="{{@trans('public.feturework')}}:" >
                                            </div>
                                            <div class="col-md-6">
                                                <label for="da_feturework">{{@trans("public.da_feturework")}}<span style="color:red"> : </span></label>
                                                <input type="text" value="" name="da_feturework" id="da_feturework" class="form-control" placeholder="{{@trans('public.da_feturework')}} :" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="register_date" placeholder="{{@trans('public.registerdate')}}" class="form-control" id="register_date">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="salary" id="salary" placeholder="{{@trans('public.salary')}}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="text-center">
                                                <button type="submit"  class="btn  btn-success" >
                                                    {{@trans("public.insert")}}<i class="fa fa-check"></i>
                                                </button>
                                                <a href="employees"  class="btn  default" >
